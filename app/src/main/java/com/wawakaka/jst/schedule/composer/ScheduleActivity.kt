...
class ScheduleActivity : BaseActivity(), FlexibleAdapter.OnItemClickListener {
...
//todo add loading view
    ...
    private fun scheduleHolderList(jadwalKelas: MutableList<JadwalKelas>) {
        list.clear()
        jadwalKelas.map { list.add(ScheduleHolder(it)) }
    }
